...
class RG2:
    ...
    def __init__(self, RobotParameter,interface_net='eth0'):
        import netifaces as ni
        ni.ifaddresses(interface_net)
        self.ip = ni.ifaddresses(interface_net)[ni.AF_INET][0]['addr']
        ...
        def StartBackgroundListenerService():
            ...
            while self.MonitorThreadRunning == True:
                try:
                    ...
                    server_address = (self.ip, 50002)#50001)
